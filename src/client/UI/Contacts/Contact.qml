...
Item{
    ...
    property variant media: fillMedia()
    property variant groups: fillGroups()
    ...
    function fillGroups() {
	return conversationGroupsModel
    } 
    ...
    Component {
	    ...
	    contactMedia: container.media
	    contactGroups: container.groups
        }
    }
